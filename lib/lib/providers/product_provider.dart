...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts() async {
    const url =
        'https://shopapp-82ac2-default-rtdb.firebaseio.com/products.json';
    try {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url =
          'https://shopapp-82ac2-default-rtdb.firebaseio.com/products/$id.json';
  ...
  void deleteProduct(String id) {
    final url = Uri.parse(
        'https://shopapp-82ac2-default-rtdb.firebaseio.com/products/$id');
